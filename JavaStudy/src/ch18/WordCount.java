...
public class WordCount {
	...
	public static void main(String[] args) {
		...
		StringBuffer text = new StringBuffer(); //많을 땐 StringBuffer 사용하기 
		...
		String[] words = text.toString().split(" "); //띄어쓰기를 기준으로 배열을 만든다. 안촉촉한=0 초코칩 =1 나라에 =2 살던 =3 안촉촉한 =4 ***
		...
		//key를 set으로 바꾸기 set은 get이 없어 iterator를 쓴다.
		Set<String> keys = wordMap.keySet();
		Iterator<String> iter = keys.iterator(); //key집합을 iterator로 변환
		while (iter.hasNext()) {
